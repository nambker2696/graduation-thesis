...
RSpec.describe Admin::BookingsController, type: :controller do
  ...
  # Admin::BookingsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Booking" do
        expect {
          post :create, params: {admin_booking: valid_attributes}, session: valid_session
        }.to change(Booking, :count).by(1)
      end

      it "redirects to the created admin_booking" do
        post :create, params: {admin_booking: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {admin_booking: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested admin_booking" do
        booking = Booking.create! valid_attributes
        put :update, params: {id: booking.to_param, admin_booking: new_attributes}, session: valid_session
        booking.reload
        skip("Add assertions for updated state")
      end

      it "redirects to the admin_booking" do
        booking = Booking.create! valid_attributes
        put :update, params: {id: booking.to_param, admin_booking: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        booking = Booking.create! valid_attributes
        put :update, params: {id: booking.to_param, admin_booking: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
